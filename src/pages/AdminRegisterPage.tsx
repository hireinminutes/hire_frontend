...
import {
  ArrowLeft, Mail, Lock, User, Shield, CheckCircle, Zap, Globe, Eye, EyeOff
} from 'lucide-react';
...
export function AdminRegisterPage({ onNavigate }: AdminRegisterPageProps) {
  ...
  // Remove isVisible state as we don't need the fade-in animation logic for the split layout anymore
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Registration and login successful, redirect to admin dashboard
      if (onNavigate) {
      ...
      <div className="hidden lg:flex flex-col justify-center bg-slate-950 p-16 xl:p-24 text-white h-full relative">
        ...
        <div className="max-w-lg">
          ...
          <p className="text-xl text-slate-400 font-light leading-relaxed mb-16">
            Register as a platform administrator to oversee operations, manage users, and configure system settings.
          </p>
      ...
      <div className="w-full bg-white h-full flex flex-col justify-center p-8 sm:p-12 lg:p-24 overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-12 hidden lg:block">
            <h2 className="text-2xl font-light text-slate-900 tracking-wide uppercase">Create Admin Account</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            >
              {loading ? 'Registering System Access...' : 'Register Admin'}
            </Button>
          </form>

          <div className="mt-12 text-center">
            <p className="text-slate-400 text-xs uppercase tracking-widest mb-4">Existing Administrator?</p>
            <a
              href="/admin/login"
